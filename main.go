...
func main() {
	...
	app := core.NewApp(core.WithAppNameOption("distributed-scheduler"), core.WithNacosAddrOption("mse-e52dbdd6-p.nacos-ans.mse.aliyuncs.com:8848"), core.WithNacosNamespaceOption("27fdefc2-ae39-41fd-bac4-9256acbf97bc"), core.WithNacosGroupNameOption("test"), core.WithPortOption(*port), core.WithNodeIdOption(*raftId), core.WithSchedulerThreadOption(1)).RegisterGrpc(func(ctx *core.ApplicationContext, server *grpc.Server) {
